...
class CounterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CounterWeightCubit, CounterWeightCubitStates>(
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                BlocProvider.of<CounterWeightCubit>(context).counter.toString(),
              ...
              Row(
                ...
                children: [
                  CounterButtonWidget(
                    text: '-',
                    onPressed: () {
                      BlocProvider.of<CounterWeightCubit>(context).decrement();
                    },
                  ),
                  CounterButtonWidget(
                    text: '+',
                    onPressed: () {
                      BlocProvider.of<CounterWeightCubit>(context).increment();
                    },
                  ),
                ],
              ),
